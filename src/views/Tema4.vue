...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row.justify-content-center.align-items-center.tarjeta.tarjeta--BG08(style="background-color:#DCD8F2")
          .col-lg-9.col-12.mb-md-0.order-lg-2.order-2.mb-lg-0.mb-3.px-4
            .row.justify-content-center
              p La arquitectura de una base de datos se refiere al diseño integral del sistema que la sustenta. No se limita únicamente al Sistema de Gestión de Bases de Datos (SGBD), sino que abarca la integración del hardware, el software, las redes y las estrategias de distribución de datos para satisfacer los requisitos de rendimiento, disponibilidad, escalabilidad y seguridad de una aplicación.
      ...
      .col-12
        .row.justify-content-center
          .col-lg-8.col-12.mb-md-0.order-lg-1.order-2.mb-lg-0
            .row.mb-3
              .col
                p La arquitectura de una base de datos constituye el esquema que detalla la organización, interconexión y gestión de los diversos componentes de un sistema de datos. Una arquitectura bien diseñada busca equilibrar objetivos que frecuentemente están en conflicto:
            .tarjeta.tarjeta--BGC01.p-3.mb-0(style="background-color:#FFEBF1")
              .row.justify-content-center.align-items-center.mb-2
                ...
                .col-lg-10.col-12
                  ...
                  p Un sistema que ofrece un rendimiento extremadamente alto puede necesitar hardware de alto costo. 
              ...
              .row.justify-content-center.align-items-center.mb-2
                ...
                .col-lg-10.col-12
                  ...
                  p En los sistemas distribuidos, asegurar una consistencia rigurosa en todos los nodos puede comprometer la disponibilidad si la red presenta fallos (Teorema CAP). 
              ...
              .row.justify-content-center.align-items-center.mb-2
                ...
                .col-lg-10.col-12
                  ...
                  p Controles de seguridad excesivamente estrictos pueden complicar el acceso legítimo a la información.
    ...
    .row.mb-0
      ...
      .col-10.mb-3
        p.mb-0 La elección de una arquitectura depende críticamente de la naturaleza de la aplicación. Un blog personal con pocos visitantes, tiene requisitos arquitectónicos radicalmente diferentes a los de un sistema de comercio electrónico global o una plataforma de redes sociales.
    ...
    p.mb-4 Las arquitecturas de bases de datos han evolucionado desde sistemas monolíticos y centralizados hasta ecosistemas distribuidos y elásticos en la nube. De acuerdo con Özsu & Valduriez (2011), se clasifican en:

    .row.justify-content-center.align-items-center.mb-0(data-aos="flip-up")
      .col-lg-9.col-12.mb-md-0.order-lg-2.order-2
    ...
    p.mb-4 En las arquitecturas distribuidas, hay dos métodos esenciales para dividir y manejar los datos entre los nodos (Kleppmann, 2017):
      ...
      .py-3.py-md-4(titulo="Maestro-Esclavo")
        .row.justify-content-center.p-4
          ...
          .col-lg-6.order-lg-2.order-2
            p Todas las operaciones de escritura se realizan en el nodo maestro, el cual posteriormente propaga los cambios a los nodos esclavos. Las operaciones de lectura pueden llevarse a cabo desde cualquier nodo. Este modelo es el más comúnmente utilizado. 
        ...
        .row
          .col-lg-6.px-4.mb-3
            .row.justify-content-center.bg-11.p-3.h-100(style="background-color:#DCD8F2; border-radius:20px")
              ...
              p.mb-0 Se asignan rangos de la clave de particionamiento a diferentes shards (p.ej., usuarios con ID de 1 a 1,000,000 en el shard 1; 1,000,001 a 2,000,000 en el shard 2).
          ...
          .col-lg-6.px-4.mb-3
            .row.justify-content-center.bg-11.p-3.h-100(style="background-color:#DCD8F2; border-radius:20px")
              ...
              p.mb-0 Se aplica una función hash a la clave de particionamiento y el resultado determina en qué shard se almacenan los datos. Esto distribuye los datos de manera más uniforme, pero dificulta las consultas por rango.
    ...
    .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5.mb-5(style="background-color:#DCD8F2")
      ...
      .bloque-texto-g__texto.p-4(data-aos="fade-left")
        p.mb-0 La complejidad de las consultas abarca múltiples shards. El enrutamiento de consultas se vuelve más complicado y las operaciones de #[em JOIN] entre shards pueden ser muy ineficientes. El re-particionamiento #[em (re-sharding)] cuando se agregan nuevos nodos, también es una operación delicada.
