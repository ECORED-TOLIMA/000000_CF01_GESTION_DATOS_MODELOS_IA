        ...
        .row.justify-content-center.align-items-center.tarjeta.tarjeta--BG08(style="background-color:#DCD8F2")
          .col-lg-9.col-12.mb-md-0.order-lg-2.order-2.mb-lg-0.mb-3.px-4
            .row.justify-content-center
              p La arquitectura de una base de datos se refiere al diseño integral del sistema que la sustenta. No se limita únicamente al Sistema de Gestión de Bases de Datos (SGBD), sino que abarca la integración del #[em hardware], el #[em software], las redes y las estrategias de distribución de datos para satisfacer los requisitos de rendimiento, disponibilidad, escalabilidad y seguridad de una aplicación.
            ...
            .tarjeta.tarjeta--BGC01.p-3.mb-0(style="background-color:#FFEBF1")
              .row.justify-content-center.align-items-center.mb-2
                ...
                .col-lg-10.col-12
                  ...
                  p Un sistema que ofrece un rendimiento extremadamente alto puede necesitar #[em hardware] de alto costo. 
